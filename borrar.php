...
<div id="page" class="container">
	<div id="content">
		<div class="title">
			...
			<span class="byline">No entristecen las despedidas</span> </div>

			<!-- Formulario -->

			<h1>Borra Tu usuario ingresando tu correo</h1>
			<br>
      <p>Nos entristece que dejes la página, pero todo cambio meditado con Dios siempre es para bien. ¡Esperamos verte de nuevo y saber nuevas cosas de vos! ¡Siempre te esperaremos con los brazos abiertos!</p>
			<br>
			<form name="delete" method="post" action="delete.php">
			     <table width="200" border="0">
			       <tr>
			         ...
			         <td><span class="cnt">
			           <input name="correo" placeholder="Correo Electrónico" type="text" class="Input" value="" size="20" />
			         </span></td>
			       </tr>
			         <td><span class="cnt">
			           <input value="Eliminar" type="submit" class="boton"/>
			         </span></td>
			       </tr>
			     </table>
			</form>
 ...
 <!-- Fin del Formulario -->
  ...
  <div id="sidebar">
		<ul class="style1">
			<li class="first">
				<href="sesion.php">
        <div align="center"> <img src="images/delete.png" width="300" height="300"> </div>
			</li>
		</ul>
	</div>
</div>
